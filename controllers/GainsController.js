...
const getTotalGainsQuery = 'SELECT SUM(value) as total FROM public."Gains" WHERE "businessCnpj" = $1 AND "gainDate"=$2;'
...
class GainsController {
    ...
    async getTotalGains(req, res) {
        try {
            const values = [req.query.businessCnpj, req.query.dateGain]
